...
class MovingTargetDefenseDNS(app_manager.RyuApp):
    ...
    VIP_SUBNET_NETWORK_INT = (10 << 24)  # 10.0.0.0
    VIP_SUBNET_PREFIX = 8
    VIP_SUBNET_SIZE = 1 << (32 - VIP_SUBNET_PREFIX)
    VIP_SUBNET_BROADCAST_INT = VIP_SUBNET_NETWORK_INT + VIP_SUBNET_SIZE - 1
    ...
    def _learn_host(self, pkt, dpid: int):
        ...
        # Only learn hosts from first 512 usable IPs in 10.0.0.0/21
